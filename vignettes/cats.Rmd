---
title: "cats: Joint Power Analysis for Non-Symmetric Two-Stage Case-Control Designs"
date: "`r Sys.Date()`"
output:
...
vignette: >
  ...
  %\VignetteIndexEntry{cats: Joint Power Analysis for Non-Symmetric Two-Stage Case-Control Designs}
---
